    ...
    }
    {
      ...
      events = {
        ...
        initialTransaction =
          { time, ... }:
          {
            description = "Vorjahresbilanz ${formatDate time "deu"}";
          };
      };
        ...
        =
          Section
            ...
            [
                ...
                [
                  ...
                  (Section
                    ...
                    [
                      ...
                      (Section
                        {
                          title = "Sonstige Vermögensgegenstände";
                          level = Level.Gross;
                        }
                        [
                          {
                  ...
                  (Section
                    {
                      title = "Sonstiges Umlaufvermögen";
                      level = Level.Gross;
                    }
                    [
                      {
              ...
              {
                id = "Aktiva-E";
                name = "Aktiver Unterschiedsbetrag aus der Vermögensverrechnung";
              }
            ];
            ...
            [
              (Section
                ...
                [
                  ...
                  {
                    id = "Passiva-A.IV";
                    name = "Gewinn-/Verlustvortrag";
                  }
                  {
                    id = "Passiva-A.V";
                    name = "Jahresüberschuß/-fehlbetrag";
                  }
                ]
              )
              (Section
      ...
      outcome # Gewinn- und Verlustrechnung nach § 275 Abs. 5 HGB
        =
          Section
            {
              title = "Jahresüberschuss/-fehlbetrag";
              level = Level.Kleinst;
            }
            (
              if maxLevel == Level.Kleinst then
                [
                  {
                    id = "GuV-1";
                    name = "Umsatzerlöse";
      ...
      journal # Chronologische Liste aller Geschäftsvorfälle
        = import ./journal.nix {
          Gesellschaftereinzahlung = time: betrag: name: {
            inherit time;
            credit = {
              "Passiva-A.I" = betrag;
            };
          ...
          Kontofuehrungsgebuehr = time: betrag: {
            inherit time;
            credit = {
              "Aktiva-B.IV.3" = betrag;
            };
          ...
          Forderung =
            time: betrag: kunde: rechnungsnummer:
            let
              betrag' = betrag / 1.19;
            ...
            in
            {
              ...
              credit = {
                "GuV-1" = betrag';
                "Passiva-C.8.1" = steuer;
              };
              debit = {
                "Aktiva-B.II.1" = betrag;
              };
              description = "Rechnung an ${kunde} (${rechnungsnummer})";
            };
          Rechnungsbegleichung = time: betrag: rechnungsnummer: {
            inherit time;
            credit = {
              "Aktiva-B.II.1" = betrag;
            };
          ...
          Sachanlagen =
            ...
            in
            {
              ...
              debit = {
                "Aktiva-A.II.2" = betrag';
                "Aktiva-B.II.4.1" = steuer;
              };
              description = "Ankauf von ${sache}";
            };
          Gewinnruecklage = time: betrag: {
            inherit time;
            credit = {
              "Passiva-A.III.4" = betrag;
            };
            debit = {
              "Passiva-A.IV" = betrag;
            };
