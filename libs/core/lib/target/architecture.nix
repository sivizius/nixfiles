...
let
  Architecture/* :  struct { bits: integer, endianness: Endianness, family: Family } */ = type "Architecture"
    {
      inherit Endianness Family;
      inherit all families;

      from/* :  type -> (string | Architecture)? -> Architecture */ = architecture:
  ...
  Endianness/* :  enum { big, little, none } */ = type.enum "Endianness"
    {
      big = 1;
      little = 2;
      none = 3;
