...
{%
  \begin{tikzpicture}%
    ...
    \node           at  ( 0,  0 ) {\includegraphics[height=1.5em]{\source/assets/pictograms/other/ecoHazard.pdf}};
  \end{tikzpicture}%
}
\def\nfpaEtching
{%
  \begin{tikzpicture}%
    ...
    \node           at  ( 0,  0 ) {\includegraphics[height=1em]{\source/assets/pictograms/other/corrosive.pdf}};
  \end{tikzpicture}%
}
\def\nfpaExplosive
{%
  \begin{tikzpicture}%
    ...
    \node           at  ( 0,  0 ) {\includegraphics[height=1.5em]{\source/assets/pictograms/other/explosive.pdf}};
  \end{tikzpicture}%
}
