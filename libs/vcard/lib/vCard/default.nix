...
let
  ...
  parameters = {
    ...
    preference = {
      name = "PREF";
      type = types.integerBetween 0 100;
    };
    sortAs = {
      name = "SORT-AS";
      type = types.unknown;
  ...
  types = {
    ...
    boolean = {
      name = "boolean";
      inherit (bool) format isInstanceOf;
    };
    date = {
      name = "date";
    };
    ...
    float = {
      name = "float";
      inherit (float) format isInstanceOf;
    };
    integer = {
      name = "integer";
      inherit (integer) format isInstanceOf;
    };
    language = {
      name = "language-tag";
    };
    ...
    integerBetween =
      ...
      types.integer
      // {
        isInstanceOf = value: (types.integer.isInstanceOf value) && value <= upper && value >= lower;
      };
    ...
    gender = types.text // {
      ...
      isInstanceOf =
        ...
        && (value.identity or null == null || string.isInstanceOf value.identity);
    };
    ...
    text-list = types.text // {
      isInstanceOf = value: list.isInstanceOf value && list.all types.text.isInstanceOf value;
