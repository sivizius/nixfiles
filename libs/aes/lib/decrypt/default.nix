...
let
  ...
  fastRoundDecryption =
    ...
    let
      ...
      column0' = unpackDWord (
        integer.xor (integer.xor (subTD0 column0.byte0) (subTD1 column3.byte1)) (
          integer.xor (subTD2 column2.byte2) (subTD3 column1.byte3)
        )
      );
      column1' = unpackDWord (
        integer.xor (integer.xor (subTD0 column1.byte0) (subTD1 column0.byte1)) (
          integer.xor (subTD2 column3.byte2) (subTD3 column2.byte3)
        )
      );
      column2' = unpackDWord (
        integer.xor (integer.xor (subTD0 column2.byte0) (subTD1 column1.byte2)) (
          integer.xor (subTD2 column0.byte2) (subTD3 column3.byte3)
        )
      );
      column3' = unpackDWord (
        integer.xor (integer.xor (subTD0 column3.byte0) (subTD1 column2.byte1)) (
  ...
  decrypt # :  AESkey -> [ u8 ]
    =
      ...
      let
        ...
        state' = list.foldReversed applyRoundDecryption' state roundKeys';
      in
      debug.debug "decrypt" {
        data = {
          state = formatColumns state;
