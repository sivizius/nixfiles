...
let
  ...
  format/* :  D: ToDateTime @ D -> string -> string -> string */ = dateTime:
    language:
    format:
    let
      date = from dateTime;
  ...
  formatYearMonth/* :  string -> string -> string */ = dateTime:
    language:
    let
  ...
  formatYearShortMonth/* :  string -> string -> string */ = dateTime:
    language:
    let
      dateTime' = from dateTime;
    in
  ...
  from/* :  int | set | string -> DateTime */ = dateTime:
    (
  ...
  getDayName/* :  int -> string -> string */ = dayOfWeek:
    language:
    let
      days = {
  ...
  getDayShortName/* :  int -> string -> string */ = dayOfWeek:
    language:
    let
      days = {
  ...
  getMonthName/* :  int -> string -> string */ = month:
    language:
    let
      months = {
        eng = [
  ...
  getMonthShortName/* :  int -> string -> string */ = month:
    language:
    let
      months = {
        eng = [
  ...
  parseISO8601/* :  string -> DateTime | ! */ = iso8601:
    let
  ...
  parseUnixTime/* :  int -> int | float | null | string -> DateTime */ = unix:
    zoneOrName:
    let
      ...
      correctYear/* :  int -> int */ = month: if month <= march then 1 else 0;
      shiftMonth/* :  int -> int */ = month: month + march + 1 - (if month < (monthsPerYear - march) then 0 else monthsPerYear);
      ...
      leapYearsPerEra = (yearsPerEra / yearsPerCycle)   # + Regular leap years, e.g. 2004, 2008, 2012
      ...
      daysBetweenMarchZeroAndEpoch = 1970 * daysPerYear                  # Regular Days since 0000-01-01
  ...
  tryParseISO8601/* :  string -> DateTime | null */ = iso8601:
    let
      year = "([+-]?[0-9]{4})";
      zone = "(Z|Z?([+-]?[0-9]{2}))?";
      a = "([0-9]{1,2})";
      ...
      toInteger'/* :  string | null -> int | null */ = value:
        if value != null
        then
          integer value
        else
