          ...
          Tag.instantiate
            {
              ...
              __functor = { attributes, body, expectBody, name, ... } @ self:
                attrsOrBody:
                let
                  isAttributes = !expectBody
              ...
              __toString = { attributes, body, name, ... } @ self:
                type.matchPrimitiveOrPanic body
                  {
