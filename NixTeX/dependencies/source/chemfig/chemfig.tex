...
\def\CF_drawatomgroup#1#2#3{%
	...
	\CF_doifnotempty{#2}
		{\ifnum#2<1
			\CF_warning{no atom found at position #2, pershaps you misspelled the optional argument of the bond.}%
		\else
			\ifnum#2>\CF_cntatomgroup
				\CF_error{no atom found at position #2, pershaps you misspelled the optional argument of the bond.}%
			\fi
		\fi
		}%
