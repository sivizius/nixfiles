...
let
  ...
  formatUnit/* :  U: ToUnit @ [ U ] | U -> string */ = unit:
    let
  ...
  formatUnit'/* :  U: ToUnit @ [ U ] | U -> string */ = maybeUnit:
  ...
  parseValue'/* :  V: ToValue @ [ V ] | V -> Value */ = nested:
    value:
    type.matchPrimitiveOrPanic value
      {
        string =
          ...
          then
            {
              value = (integer "0${list.get parsed 1}")
  ...
  parseValue/* :  V: ToValue @ [ V ] | V -> Value */ = parseValue' true;

  formatValue/* :  V: ToValue, U: ToUnit @ V -> U -> string */ = value:
    unit:
    "\\mbox{\\ensuremath{${formatValueInMath value unit}}}";

  formatValueInMath/* :  V: ToValue, U: ToUnit @ V -> U -> string */ = value:
    unit:
    let
  ...
  formatValue'/* :  V: ToValue @ [ V ] | V -> string */ = value:
    let
