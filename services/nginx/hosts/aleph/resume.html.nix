  ...
  body = with web.html; [
    (main [
      ...
      (section [
        ...
        (dl [
          (dt "LaTeX")
          (dd "luaLaTeX, plainTeX, pdfTeX")
          (dt "Web/Frontend")
          (dd "CSS3, HTML5, JavaScript, PHP, TypeScript")
          (dt "General Purpose Languages")
          (dd "C/C++, Go, Java, Nim, PureBasic, Rust")
          (dt "Scripting Languages")
          (dd "Bash, Lua, Nix, Python 3")
          (dt "Assembly")
          (dd "fasm, nasm; amd64, x86, avr")
          (dt "Embedded")
          (dd "Arduino, AVR/ATmega, Raspberry Pi")
        ])
      ])
      (section [
        (h2 "IT-Skills")
        (dl [
          ...
          (dd "Linux (+10 years): Debian, NixOS (+4 years)")
          (dt "Server/Networking")
          (dd "bind, gitea, grafana+prometheus, let's encrypt, nginx, ssh")
          (dt "Miscellaneous")
          (dd "git, gnupg, luks, VS&nbsp;Code/Codium")
        ])
      ])
      (section [
        (h2 "Recreation")
        (dl [
          (dt "Diving")
          (dd "DTSA/CMAS* (ISO 24801-2) since 2021")
          (dt "Chess")
          (dd "For 20+ years, also in a club and regional tournaments for some time")
        ])
      ])
      (section [
        (h2 "Languages")
      ...
      (section [
        (h2 "Committees")
        (dl [
          (dt "Study Commission Bachelor/Master Chemistry (2017–2021)")
          (dd "Student Member")
          (dt "Student Council Chemistry Institute (2016–2021)")
          (dd "Full Member")
          (dt "Selection Committee for the W3-Professorship »Organic Chemistry« (2020)")
          (dd "Student Member")
      ...
      (section [
        ...
        (ol [
          (li ''
            ...
            ${
              a {
                href = "https://chemistry-europe.onlinelibrary.wiley.com/doi/10.1002/ejic.202100097";
