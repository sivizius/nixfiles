...
let
  all/* :  T, F: T -> bool @ F -> [ T ] -> bool */ = intrinsics.all
    or  (
    predicate:
    fold
      (
  ...
  any/* :  T, F: T -> bool @ F -> [ T ] -> bool */ = intrinsics.any
    or  (
    predicate:
    fold
      (
  ...
  #   F: T -> U,
  #   T, U: Any:
  concatMap = intrinsics.concatMap
    or  (
    convert:
    self:
  ...
  #   F: T -> bool,
  #   T: Any:
  partition = intrinsics.partition
    or  (
    predicate:
    groupBy
      (
