...
{ domain, ... }:
{
  body = [
    ''
      ...
      Fefes-Blog-Text: In der Politik lässt man keine Krise ungenutzt verstreichen, [...]
      ...
      # I own the following accounts on platforms that are not my own:
      Duolingo: sivizius
      ...
      Canonical: https://${domain}/.well-known/canary.txt
