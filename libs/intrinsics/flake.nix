    ...
    let
      ...
      lib = {
        ...
        **/
        ...
        inherit (builtins) derivationStrict;
        ...
        */
        ...
        #!  TODO: Documentation
        inherit (builtins) fetchMercurial;
        ...
        inherit (builtins) genericClosure;
