  ...
  formatPicture = position:
    ...
    then
      [
        ...
        indentation.more
        { "left" = "\\raggedright{%"; "right" = "\\raggedleft{%"; }.${align}
        indentation.more
        "\\begin{tikzpicture}%"
        indentation.more
        "\\node[%"
